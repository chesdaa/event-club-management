...
function showClubModal(clubId) {
    ...
    content.innerHTML = `
        <div class="club-detail">
            <div class="club-logo" style="width: 120px; height: 120px; font-size: 4rem; margin: 0 auto 1.5rem;">${club.logo}</div>
            <h2 style="text-align: center;">${club.name}</h2>
            <p style="text-align: center; color: var(--text-secondary); margin-bottom: 2rem;">${club.description}</p>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 1rem; margin: 2rem 0; text-align: center;">
                <div style="background: var(--light-bg); padding: 1rem; border-radius: 8px;">
                    <strong style="font-size: 2rem; color: var(--primary-color);">${club.members}</strong>
                    <p style="color: var(--text-secondary);">Members</p>
                </div>
                <div style="background: var(--light-bg); padding: 1rem; border-radius: 8px;">
                    <strong style="font-size: 2rem; color: var(--primary-color);">${club.events}</strong>
                    <p style="color: var(--text-secondary);">Events</p>
                </div>
                <div style="background: var(--light-bg); padding: 1rem; border-radius: 8px;">
                    <strong style="font-size: 1.2rem; color: var(--primary-color);">${club.founded}</strong>
